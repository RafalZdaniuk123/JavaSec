...
<c:if test="condition"></c:if>
        <c:forEach var="order" items="${orders}" >
                    <c:url var="done" value="/order/done">
            ...
            <tr>
                ...
                <tr>
                   ...
                   <td>${order.status}</td>
                     ...
                     <c:choose>
                                                     <c:when test="${order.status=='Zrealizowane'}">
                                                        <td><a style="display:none;" href="${done}">Wykonano</a></td>
                                                        </c:when>
                                                         <c:otherwise>
                                                             <td> <td><a class="as" href="${done}">Wykonano</a></td></td>
