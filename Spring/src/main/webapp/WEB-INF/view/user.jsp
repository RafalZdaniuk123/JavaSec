            ...
            <tr>
                ...
                <td><c:out value="${book.autorzy}"/></td>
                    ...
                    <sec:authorize access="hasRole('ROLE_USER') and isAuthenticated()">
                                                ...
                                                <c:choose>
                                                            <c:when test="${book.ilosc=='0'}">
                                                            <td><a style="display:none;" href="${addToCart}">Dodaj do koszyka</a></td>

                                                  </c:when>
                                                   <c:otherwise>
                                                          <td><a class="as" href="${addToCart}">Dodaj do koszyka</a></td>
...
<sec:authorize access="hasRole('ROLE_USER') and isAuthenticated()">
    ...
    <a class = "as"href="${pageContext.request.contextPath}/cart/cart">Koszyk</a>
 </sec:authorize>
